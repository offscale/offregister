...
package_name_verbatim = "offregister"
...
def main():
    ...
    templates_join = gen_join_on_pkg_name("aux_recipes", "templates")
    ...
    setup(
        ...
        install_requires=["pyyaml", "apache-libcloud", "grpcio == 1.29.0 ; python_version<'3.5'", "etcd3"],
        package_data={
            package_name: list(
                chain.from_iterable(
                    map(
